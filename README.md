...
# **Shortage of Funds**: A Cost Optimization Problem (?)
How could we tackle this? 

This project is intended to develop a familiarity with using GIS data, ascertaining it's utility, and develop/formulate ways in which GIS data may inform project costs and prevent project delays. Each question itemized about will be struckthrough, indicating an answered question. 
